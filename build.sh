...
NFS_BUILDER_OPT_DEFINE="-DNO_STORAGE -DNO_ENFORCING_ORDER -DENFORCING_NOP -DWITHOUT_PLANE_STATS"
NFS_BUILDER_CUR_PATH="/mnt/d/Program Files/NFS-master"
NFS_BUILDER_NFS_PATH="${NFS_BUILDER_CUR_PATH}/nfs"
NFS_BUILDER_BOOST_PATH='/mnt/d/Program Files/boost_1_81_0'
...
then
	# There is --shared-lib option parameter
	# Make shared library file of NANDFlashSim
	echo ${NFS_BUILDER_INFO_COMMENT}"Make shared library file of NANDFlashSim"
